          ...
          {TABS.map((tab) => {
            ...
            return (
              <button
                ...
                className={cn(
                  'inline-flex cursor-pointer items-center gap-2 rounded-base border-2 border-border px-4 py-2 text-sm font-sans font-semibold uppercase tracking-wide shadow-shadow transition-all',
